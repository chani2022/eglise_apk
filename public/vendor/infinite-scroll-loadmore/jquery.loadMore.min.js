...
var l=getPath();$.fn.loadMore=function(d){var e=$("<div class='_loadMore-imgLoading'><img src='"+l+"images/load.gif'><span class='loadText'>Loading...</span></div>");var f=$('<div class="_loadMore-click"><span>Load More</span></div>');var g,opts,contentH,viewH,scrollTopH,running=false,DEFAULTS={loadType:'auto',ajaxSwitch:true,url:'',data:{},type:'get',success:function(){},error:function(){},callback:function(){},async:true,dataType:'json',conLocation:"",scrollBottom:100,imgLoading:e,clickLoading:f,};function Load(){this.init=function(a){opts=$.extend({},DEFAULTS,d);if(opts.conLocation){opts.conLocation=$(opts.conLocation)}else if(a[0]===j||a[0]===i){opts.conLocation=$("body");g=$(j)}else{opts.conLocation=a;g=a}
